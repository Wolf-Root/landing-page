        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        Discuss your goals, determine success metrics, identify
                        problems
                    </motion.p>
                    <motion.div
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className=" mt-8 bg-indigo-600 text-lg md:text-xl font-bold text-white py-3 px-8 rounded-full duration-300 cursor-pointer hover:bg-indigo-700"
                    >
                        Get started
                    </motion.button>
                </motion.div>
                ...
                >
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            whileHover={{ scale: 1.05 }}
                            key={index}
                            className="bg-white max-w-72 cursor-pointer rounded-2xl p-6 transition-all duration-300 hover:shadow-xl hover:scale-105"
                        >
                            <motion.div
