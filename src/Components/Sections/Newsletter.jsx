                    ...
                    <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="text-blue-200 text-base sm:text-lg md:text-xl font-semibold"
                            >
                                Best cooks and best delivery guys all at your
                                service. Hot tasty food
                            </motion.p>
                        </motion.div>
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="flex items-center gap-2 w-full bg-green-500 sm:w-auto cursor-pointer text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-r-xl sm:rounded-l-none"
                            >
                                <span>Discover</span>
                                <FontAwesomeIcon
                                    icon={faArrowRight}
