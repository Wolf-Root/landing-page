            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
                ...
                >
                    <motion.span
                        ...
                        className="text-lg md:text-xl font-semibold text-green-500 uppercase"
                    >
                        Monitor
                    </motion.span>
                    <motion.h2
                    ...
                    >
                        Before the ship is really back. Round, mund, all around
                        the world. Round, all around the world. Round, all
